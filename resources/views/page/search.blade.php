...
<div class="box search-container">
    <form id="items-search-form" class="search-form" action="{{ route('search') }}" accept-charset="UTF-8" method="post">
        @csrf
...
<div class="box items-grid no-background">
    <div class="items-container" id="search_items_container">
        ...
        <div id="item_104800" class="item thumb videobox grid-column">
            <a title="{{ __('Trò chơi') }} {{ $game['name'] }} - {{ __('Chơi trực tuyến tại') }} {{ env('APP_NAME', 'Gamekafe') }}" href="{{ route('play.games', ['game' => strtolower(str_replace(' ', '-', $game['name']))]) }}">
