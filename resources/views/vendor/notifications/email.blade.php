...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Albert+Sans:wght@400;500;600;800&display=swap" rel="stylesheet" type="text/css">
</head>

<body class=t0 style="min-width:100%;Margin:0px;padding:0px;background-color:#0D0D0D;">
                        ...
                        <tr>
                            <td>
                                <table class=t10 role=presentation cellpadding=0 cellspacing=0 align=center>
                                    <tr>
                                        <td class=t11 style="overflow:hidden;width:770px;padding:0 15px 0 15px;">
                                            <table role=presentation width=100% cellpadding=0 cellspacing=0>
                                                ...
                                                <tr>
                                                    <td>
                                                        <table class=t34 role=presentation cellpadding=0 cellspacing=0 align=center>
                                                            <tr>
                                                                <td class=t35 style="background-color:#EFE3D7;overflow:hidden;width:550px;padding:40px 25px 40px 25px;border-radius:0 0 13px 13px;">
                                                                    <div class=t41 style="display:inline-table;width:100%;text-align:left;vertical-align:top;">
                                                                        <div class=t45 style="display:inline-table;text-align:initial;vertical-align:inherit;width:100%;max-width:617px;">
                                                                            <div class=t46 style="padding:0 15px 0 15px;">
                                                                                <table role=presentation width=100% cellpadding=0 cellspacing=0 class=t47>
                                                                                    <tr>
                                                                                        <td class=t48 style="overflow:hidden;">
                                                                                            <table role=presentation width=100% cellpadding=0 cellspacing=0>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <table class=t63 role=presentation cellpadding=0 cellspacing=0 align=center>
                                                                                                            <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <table class=t90 role=presentation cellpadding=0 cellspacing=0 align=center>
                                                            <tr>
                                                                <td class=t91 style="overflow:hidden;width:400px;padding:30px 0 30px 0;">
                                                                    <table role=presentation width=100% cellpadding=0 cellspacing=0>
                                                                        <tr>
                                                                            <td>
