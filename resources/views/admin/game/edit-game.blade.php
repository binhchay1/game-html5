...
<div class="container">
    <form action="{{ route('game.update', $dataGame['id']) }}" method="POST" class="row g-3" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            ...
            <input name="name" value="{{ old('name', $dataGame['name']) }}" type="text" class="form-control @error('name') is-invalid @enderror" id="name-store-game">
            @error('name')
        ...
        <div class="col-md-1">
            ...
            <input type="text" name="count_play" value="{{ $dataGame['count_play'] }}" class="form-control">
        </div>
        <div class="col-md-2">
